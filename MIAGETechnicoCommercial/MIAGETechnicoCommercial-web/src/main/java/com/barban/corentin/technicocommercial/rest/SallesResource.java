 ...
 * @author Corentin
 */
@Path("formationsCatalogue/{code}/salles")
@RequestScoped
public class SallesResource {
    ...
    /**
     * Retrieves representation of an instance of com.barban.corentin.technicocommercial.rest.SallesResource
     * @return an instance of java.lang.String
     */
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public String getJson(@PathParam("code") String code) {
        return this.gson.toJson(this.serviceTechnicoCommercial.rechercherSallesAdequates(code));
    }
